...
func GetStuff(client *http.Client, baseurl string, token string) ([]ArtifactoryRepoResponse, []ArtifactoryPermissionDetails, error) {
	...
	return repos, permissiondetails, nil
}
